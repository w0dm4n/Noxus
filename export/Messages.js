...
export class BasicStatWithDataMessage extends BasicStatMessage {
    constructor(param1, param2, param) {
        super(param1, param2);
        this.datas = param3;
        this.messageId = 6573;
    }
...
export class IdentificationAccountForceMessage extends IdentificationMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param8, param9, param1) {
...
export class IdentificationSuccessWithLoginTokenMessage extends IdentificationSuccessMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param1) {
...
export class SelectedServerDataExtendedMessage extends SelectedServerDataMessage {
    constructor(param1, param2, param3, param4, param5, param) {
...
export class AchievementFinishedInformationMessage extends AchievementFinishedMessage {
    constructor(param1, param2, param3, param) {
        super(param1, param2);
        this.name = param3;
...
export class AbstractGameActionFightTargetedAbilityMessage extends AbstractGameActionMessage {
    constructor(param1, param2, param3, param4, param5, param6, param) {
        super(param1, param2);
...
export class GameActionFightCloseCombatMessage extends AbstractGameActionFightTargetedAbilityMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param) {
...
export class GameActionFightExchangePositionsMessage extends AbstractGameActionMessage {
    constructor(param1, param2, param3, param4, param) {
        super(param1, param2);
        this.targetId = param3;
...
export class GameFightResumeWithSlavesMessage extends GameFightResumeMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param8, param) {
...
export class MapComplementaryInformationsDataInHavenBagMessage extends MapComplementaryInformationsDataMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param1) {
        super(param1, param2, param3, param4, param5, param6, param7, param8, param9);
...
export class MapComplementaryInformationsWithCoordsMessage extends MapComplementaryInformationsDataMessage {
    constructor(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param1) {
        super(param1, param2, param3, param4, param5, param6, param7, param8, param9);
        this.worldX = param10;
        this.worldY = param11;
        this.messageId = 6268;
...
// Generated by Noxus messages 
export class SpellVariantActivationMessage extends ProtocolMessage {
    ...
    serialize() {
        ...
        if (this.activatedSpellId < 0) {
            Logger.error("Forbidden value (" + this.activatedSpellId + ") on element activatedSpellId.");
        }
        this.buffer.writeVarShort(this.activatedSpellId);
        if (this.deactivatedSpellId < 0) {
            Logger.error("Forbidden value (" + this.deactivatedSpellId + ") on element deactivatedSpellId.");
        }
    ...
    deserialize(buffer) {
        ...
        if (this.activatedSpellId < 0) {
            Logger.error("Forbidden value (" + this.activatedSpellId + ") on element of SpellVariantActivationMessage.activatedSpellId.");
        }
        this.deactivatedSpellId = buffer.readVarUhShort();
        if (this.deactivatedSpellId < 0) {
            Logger.error("Forbidden value (" + this.deactivatedSpellId + ") on element of SpellVariantActivationMessage.deactivatedSpellId.");
        }
    }
}

// Generated by Noxus messages 
export class SpellVariantActivationRequestMessage extends ProtocolMessage {
    constructor(spellId) {
        super(6707);
        this.spellId = spellId;
    }
    ...
    deserialize(buffer) {
        this.spellId = buffer.readVarUhShort();
        if (this.spellId < 0) {
            Logger.error("Forbidden value (" + this.spellId + ") on element of SpellVariantActivationRequestMessage.spellId.");
        }
    }
}
...
// Generated by Noxus messages 
export class FinishMoveSetRequestMessage extends ProtocolMessage {
    ...
    deserialize(buffer) {
        ...
        if (this.finishMoveId < 0) {
            Logger.error("Forbidden value (" + this.finishMoveId + ") on element of FinishMoveSetRequestMessage.finishMoveId.");
        }
...
// Generated by Noxus messages 
export class ShortcutBarReplacedMessage extends ProtocolMessage {
    constructor(barType, shortcut) {
        super(6706);
        this.barType = barType;
        this.shortcut = shortcut;
    ...
    deserialize(buffer) {
        this.barType = buffer.readByte();
        if (this.barType < 0) {
            Logger.error("Forbidden value (" + this.barType + ") on element of ShortcutBarReplacedMessage.barType.");
        }
        var _loc2_ = buffer.readUnsignedShort();
        this.shortcut = ProtocolTypeManager.getInstance(Shortcut, _loc2_);
        this.shortcut.deserialize(buffer);
