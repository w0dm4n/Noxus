...
export class GameActionMark {
    ...
    serialize(buffer) {
        ...
        buffer.writeByte(this.markSpellLevel);
    ...
    deserialize(buffer) {
        ...
        this.markSpellLevel = buffer.readByte();
        if (this.markSpellLevel < 1 || this.markSpellLevel > 6) {
...
export class GuildInAllianceInformations extends GuildInformations {
    constructor(param1, param2, param3, param4, nbMembers, enabled) {
        super(param1, param2, param3, param4);
...
export class GuildInsiderFactSheetInformations extends GuildFactSheetInformations {
    constructor(param1, param2, param3, param4, param5, param6, leaderName, nbConnectedMembers, nbTaxCollectors, lastActivity, enabled) {
        super(param1, param2, param3, param4, param5, param6);
